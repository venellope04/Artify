            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <!--    <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">-->
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="Timetable.html" class="dropdown-item">Insert</a>
                            <a href="TimetableEdit.php" class="dropdown-item">Update</a>
                            <a href="TimetableDelete.php" class="dropdown-item">Delete</a>
                            <a href="TimetableView.php" class="dropdown-item">View</a>
                        </div>
                    </div>
...
while($row=mysql_fetch_array($result))
{
    ...
    $DB_id=$row['id'];
    $DB_did=$row['days_id'];
    $DB_tid=$row['timeslot_id'];
    $DB_sid=$row['subject_id'];
...
<td><?php echo $DB_did;?></td>
<td><?php echo $DB_tid;?></td>
<td><?php echo $DB_sid;?></td>

<td><a class="button" href="TimeslotEditDetails.php?id=<?php echo $DB_id;?>">Edit</a></td>
</tr>
