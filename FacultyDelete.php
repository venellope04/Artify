            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">-->
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="Faculty.html" class="dropdown-item">Insert</a>
                            <a href="FacultyEdit.php" class="dropdown-item">Update</a>
                            <a href="FacutlyDelete.php" class="dropdown-item">Delete</a>
                            <a href="FacultyView.php" class="dropdown-item">View</a>
                        </div>
                    </div>
...
while($row=mysql_fetch_array($result))
{
    ...
    $DB_Fno=$row['fno'];
    $DB_Fdesg=$row['fdg'];
    $DB_Fcontact=$row['fcno'];
    $DB_Fmail=$row['fmail'];
?>


<td><?php echo $DB_Fname;?></td>
<td><?php echo $DB_Fno;?></td>
<td><?php echo $DB_Fdesg;?></td>
<td><?php echo $DB_Fcontact;?></td>
<td><?php echo $DB_Fmail;?></td>

<td><a class="button" href="FacultyDeleteDetails.php?fno=<?php echo $DB_Fno;?>">Delete</a></td>
</tr>
