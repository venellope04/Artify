                ...
                <!--    <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">-->
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="FacultyDelete.php" class="dropdown-item">Delete</a>
...
<td><?php echo $DB_Fcno;?></td>
<td><?php echo $DB_Fmail;?></td>

<td><a class="button" href="FacultyEditDetails.php?fno=<?php echo $DB_Fno;?>">Edit</a></td>
</tr>
