                ...
                <div class="nav-item dropdown">
                   ...
                   <!-- <a href="aabout.html" class="nav-item nav-link">About us</a>--> 
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="Allotment.html" class="dropdown-item">Insert</a>
                            <a href="AllotmentEdit.php" class="dropdown-item">Update</a>
                            <a href="AllotmentDelete.php" class="dropdown-item">Delete</a>
                            <a href="AllotmentView.php" class="dropdown-item">View</a>
                        </div>
                    </div>
                    </div>
...
<td><?php echo $DB_Th;?></td>
<td><?php echo $DB_Cr;?></td>

<td><a class="button" href="AllotmentDeleteDetails.php?cr=<?php echo $DB_Cr;?>">Delete</a></td>
</tr>
