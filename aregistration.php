...
if(isset($_POST['insert']))
{
     ...
     if(mysql_query($sql,$conn))
    {
        ...
        echo ("<script LANGUAGE='JavaScript'>window. location. href='RegistrationView.php';</script>");
    }
    else
    {
        echo "<script>alert('Something is wrong please register again');</script>";
        echo ("<script LANGUAGE='JavaScript'>window. location. href='aRegistration.html';</script>");
    }
}
mysql_close($conn);
