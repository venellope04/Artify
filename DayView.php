               ...
               <!-- <div class="nav-item dropdown">
                ...
                <!--        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"> Masters </a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="Day.html" class="dropdown-item">Insert</a>
                            <a href="DayEdit.php" class="dropdown-item">Update</a>
                            <a href="DayDelete.php" class="dropdown-item">Delete</a>
                            <a href="DayView.php" class="dropdown-item">View</a>
                        </div>
                    </div>
