                ...
                <div class="nav-item dropdown">
                   <li class="nav-item dropdown">
                       ...
                       <!-- </li>
                        ...
                        <!--<ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#"> Actions &raquo </a>
                   ...
                   <!-- <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="AllotmentView.php" class="dropdown-item">View</a>
                                ...
                                <li>
                                <!--<a class="dropdown-item" href="#"> Air Booking   &raquo </a>
...
<td><a class="button" href="AllotmentEditDetails.php?cr=<?php echo $DB_Cr;?>">Edit</a></td>
</tr>
