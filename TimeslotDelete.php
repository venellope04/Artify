                ...
                <!--<div class="nav-item dropdown">
                   ...
                   <!-- <div class="nav-item dropdown">-->
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="Timeslot.html" class="dropdown-item">Insert</a>
                            <a href="TimeslotEdit.php" class="dropdown-item">Update</a>
                            <a href="TimeslotDelete.php" class="dropdown-item">Delete</a>
                            <a href="TimeslotView.php" class="dropdown-item">View</a>
                        </div>
                   </div>
...
while($row=mysql_fetch_array($result))
{
    ...
    $DB_id=$row['id'];
    $DB_stm=$row['start_time'];
    $DB_etm=$row['end_time'];
?>


<td><?php echo $DB_id;?></td>
<td><?php echo $DB_stm;?></td>
<td><?php echo $DB_etm;?></td>


<td><a class="button" href="TimeslotDeleteDetails.php?id=<?php echo $DB_id;?>">Delete</a></td>
</tr>
