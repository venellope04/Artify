            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="Classroom.html" class="dropdown-item">Insert</a>
                            <a href="ClassroomEdit.php" class="dropdown-item">Update</a>
                            <a href="ClassroomDelete.php" class="dropdown-item">Delete</a>
                            <a href="ClassroomView.php" class="dropdown-item">View</a>
                        </div>
                    </div>
...
<td><?php echo $DB_Bname;?></td>

<td><a class="button" href="ClassroomDeleteDetails.php?cname=<?php echo $DB_Cname;?>">Delete</a></td>
</tr>
        ...
        <div class="container pt-5">
            <div class="row g-5 pt-4">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="bi bi-envelope-open text-primary me-2"></i>attgproject@gmail.com@gmail.com</p>
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-md-9 text-center text-md-start">
                    <p class="mb-md-0"><a class="text-white border-bottom" href="#">MedTour </a>&copy; <a class="text-white border-bottom" href="#">Sankruti Gohil, Mitanshu Sinha, Shivang Rana, Ikhlas Khan</a>. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
